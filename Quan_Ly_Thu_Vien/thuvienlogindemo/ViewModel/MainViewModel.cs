...
namespace thuvienlogindemo.ViewModel
{
	public class MainViewModel : BaseViewModel
	{
		...
		public ICommand TextChangedchucnangCommand { get; set; }
		...
		//closeapp
			...
			Maximize = new RelayCommand<Window>((p) => { if (p != null) return true; return false; }, (p) =>
			{
				...
				else
				{
					...
					TextTimKiem = "tìm gì đi bạn ơi";
				}
			}
			);
			//minisize
