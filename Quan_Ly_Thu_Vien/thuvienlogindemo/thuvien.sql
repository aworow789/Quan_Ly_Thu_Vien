...
INSERT [dbo].[NguoiDung] ([MaND], [TenND], [NgaySinh], [GioiTinh], [DiaChi], [SDT], [TenDangNhap], [MatKhau],[Admin], [NhanVienKho], [NhanVienBan]) VALUES (5, N'Nguyễn Tấn Toàn', CAST(N'2001-09-27T00:00:00.000' AS DateTime), 1, N' 1017 D6 Khu B, HCM - VNU, Trái đất- Hành tinh số 7, Vũ trụ 7', N'0398564212', N'toan', N'87d9bb400c0634691f0e3baaf1e2fd0d',1,0,0,0)
